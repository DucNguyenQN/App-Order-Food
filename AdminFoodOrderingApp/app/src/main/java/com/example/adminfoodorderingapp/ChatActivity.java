...
import com.example.adminfoodorderingapp.adapter.ChatAdapter;
import com.example.adminfoodorderingapp.adapter.ChatListAdapter;
import com.example.adminfoodorderingapp.databinding.ActivityChatBinding;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void getNameRes() {
        DatabaseReference resName = FirebaseDatabase.getInstance().getReference().child("user").child(receiverId).child("userName");
